...
public final class ServletContextImpl implements KrakenServletContext {
	private final Logger logger = LoggerFactory.getLogger(ServletContextImpl.class.getName());
