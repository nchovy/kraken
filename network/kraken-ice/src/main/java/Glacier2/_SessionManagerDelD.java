...
public final class _SessionManagerDelD extends Ice._ObjectDelD implements _SessionManagerDel
{
    public SessionPrx
    create(final String userId, final SessionControlPrx control, java.util.Map<String, String> __ctx)
