...
{
    public SessionPrx
    createSession(final String userId, final String password, java.util.Map<String, String> __ctx)
               ...
               SessionNotExistException
    {
        ...
        __initCurrent(__current, "destroySession", Ice.OperationMode.Normal, __ctx);
    ...
    {
        final Ice.Current __current = new Ice.Current();
        __initCurrent(__current, "getCategoryForClient", Ice.OperationMode.Nonmutating, __ctx);
    ...
    {
        final Ice.Current __current = new Ice.Current();
        __initCurrent(__current, "refreshSession", Ice.OperationMode.Normal, __ctx);
        IceInternal.Direct __direct = null;
        try
        {
            __direct = new IceInternal.Direct(__current)
        ...
        throws IceInternal.LocalExceptionWrapper
    {
        ...
        final Ice.ObjectProxySeqHolder __result = new Ice.ObjectProxySeqHolder();
        IceInternal.Direct __direct = null;
        try
        {
            __direct = new IceInternal.Direct(__current)
