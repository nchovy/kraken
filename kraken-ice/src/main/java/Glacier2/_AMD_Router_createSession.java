...
final class _AMD_Router_createSession extends IceInternal.IncomingAsync implements AMD_Router_createSession
{
    public
    _AMD_Router_createSession(IceInternal.Incoming in)
    {
        super(in);
    }
