 ...
 */
package org.krakenapps.http.internal.dispatch;
...
public final class InvocationFilterChain extends HttpFilterChain {
	...
	public InvocationFilterChain(FilterHandler[] handlers, ServletPipeline servletPipeline,
	...
	protected void doFilter(HttpServletRequest req, HttpServletResponse res) throws IOException,
			ServletException {
		this.index++;
