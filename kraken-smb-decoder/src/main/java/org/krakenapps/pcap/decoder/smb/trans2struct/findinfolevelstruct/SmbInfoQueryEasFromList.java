...
public class SmbInfoQueryEasFromList implements TransStruct{
	...
	public String toString(){
		return String.format("Third Level Structure : Smb Info Query Eas From List\n" +
				"resumeKey = %s\n" +
				"creationDate = 0x%s , creationTime = 0x%s , lastAccessDate = 0x%s\n" +
				"lastAccessTime = 0x%s , lastWriteDate = 0x%s, lastWriteTime = 0x%s\n" +
				"filedataSize = 0x%s , allocationSize = 0x%s , attributes = %s\n" +
				"eaSize = 0x%s , fileNameLength = 0x%s\n" +
				"fileName = %s\n",
				this.resumekey,
				...
				Integer.toHexString(this.eaSize) , Integer.toHexString(this.fileNameLength),
				this.fileName);
	}
}
