...
//0x81
public class SearchRequest implements SmbData{
	...
	SmbResumeKey []resumeKey;// resumeKeyength  mod 21
	...
	public String toString(){
		return String.format("First Level : Search Reqeuest\n" +
				"isMalformed = %s\n" +
				"wordCount = 0x%s\n" +
				"maxCount = 0x%s , searchAttribute = %s\n" +
				"byteCount = 0x%s" +
				"bufferFormat1 = 0x%s , fileName = %s\n" +
				"bufferFormat2 = 0x%s , resumeKeyLength = 0x%s , resumKey = %s\n",
				this.malformed,
