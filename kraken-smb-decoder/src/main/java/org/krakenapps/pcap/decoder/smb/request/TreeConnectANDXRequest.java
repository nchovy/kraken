...
public class TreeConnectANDXRequest implements SmbData{

	
	boolean malformed = false;
	public final static short TREE_CONNECT_ANDX_DISCONNECT_TID = 0x0001;
	public final static short TREE_CONNECT_ANDX_EXTNEDED_SIGNATURES = 0x0004;
	public final static short TREE_CONNECT_ANDX_EXTENDED_RESPONSE = 0x0008;
	...
	public boolean isTreeConnectAndxExtendedSignatures()
	{
		if((this.flags & TREE_CONNECT_ANDX_EXTNEDED_SIGNATURES)== TREE_CONNECT_ANDX_EXTNEDED_SIGNATURES)
			return true;
		else
			return false;
	}public boolean isTreeConnectAndxExtendedResponse()
	{
		if((this.flags & TREE_CONNECT_ANDX_EXTENDED_RESPONSE)== TREE_CONNECT_ANDX_EXTENDED_RESPONSE)
			return true;
		else
			return false;
	}
	...
	public String toString(){
		return String.format("First Level : TreeConnect Andx Request\n" +
				"isMalformed = %s \n" +
				"wordCount = 0x%s\n" +
