...
public class Btree implements CursorCallback {
	private final Logger logger = LoggerFactory.getLogger(Btree.class.getName());
	...
	private Page insert(Page page, RowKey key, RowEntry value) throws IOException {
		...
		default:
			throw new IllegalArgumentException("unsupported page type: " + flag);
		}
	}
