...
public class NetworkAddressApiImpl implements NetworkAddressApi {
	...
	@Transactional
	@Override
	public void updateNetworkAddress(int organizationId, int id, String name, int type, String address1, String address2) {
		EntityManager em = entityManagerService.getEntityManager();
	...
	@Transactional
	@Override
	public void removeNetworkAddress(int organizationId, int id) {
		EntityManager em = entityManagerService.getEntityManager();
