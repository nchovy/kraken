...
//0x83
public class FindUniqueRequest implements SmbData{

	private boolean malformed = false;
	//param
	private byte wordCount;
	private short maxCount;
	private FileAttributes searchAttribytes;
	//data
	...
	private SmbResumeKey []resumeKey;
	...
	public String toString(){
		return String.format("First Level : Find Unique Request\n"+
				"isMalformed = %s\n"+
				"wordCount = 0x%s\n"+
				"maxCount = 0x%s\n"+
				"searchAttribute = %s\n"+
				...
				"bufferForamt2 = 0x%s , resumeKeyLength = 0x%s , resumeKey = %s\n",
				this.malformed,
				Integer.toHexString(this.wordCount),
				Integer.toHexString(this.maxCount),
				this.searchAttribytes,
