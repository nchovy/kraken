...
//0x81
public class SearchResponse implements SmbData{
	...
	public String toString(){
		return String.format("First Level : Search Response \n" +
				"isMalformed = %s\n" +
				"wordCount = 0x%s\n" +
				"count = 0x%s\n" +
				"byteCount = 0x%s\n" +
				...
				Integer.toHexString(this.bufferFormat), Integer.toHexString(this.dataLength) ,this.directoryInformationData);
	}
}
