...
public class TableBottomBorder extends AbstractWordElement {
	...
	public TableBottomBorder() {
	}

	public TableBottomBorder(String value, int size, int space, HexColor color) {
		this.value = value;
		this.size = size;
		this.space = space;
		this.color = color;
