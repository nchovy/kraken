...
public class TableLeadingEdgeBorder extends AbstractWordElement {
	...
	public TableLeadingEdgeBorder() {
	}

	public TableLeadingEdgeBorder(String value, int size, int space, HexColor color) {
		this.value = value;
		this.size = size;
		this.space = space;
		this.color = color;
