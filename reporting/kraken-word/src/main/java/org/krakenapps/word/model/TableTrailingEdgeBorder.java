...
public class TableTrailingEdgeBorder extends AbstractWordElement {
	...
	public TableTrailingEdgeBorder() {
	}

	public TableTrailingEdgeBorder(String value, int size, int space, HexColor color) {
		this.value = value;
		this.size = size;
		this.space = space;
		this.color = color;
