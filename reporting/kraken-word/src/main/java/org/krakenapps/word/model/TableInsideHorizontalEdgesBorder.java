...
public class TableInsideHorizontalEdgesBorder extends AbstractWordElement {
	...
	public TableInsideHorizontalEdgesBorder() {
	}

	public TableInsideHorizontalEdgesBorder(String value, int size, int space, HexColor color) {
		this.value = value;
		this.size = size;
		this.space = space;
		this.color = color;
