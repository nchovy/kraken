...
@Component(name = "sentry-script-factory")
@Provides
public class SentryScriptFactory implements ScriptFactory {
	@SuppressWarnings("unused")
	@ServiceProperty(name = "alias", value = "sentry")
	...
	public Script createScript() {
		return new SentryScript(sentry, rpc, watchdog);
	}
