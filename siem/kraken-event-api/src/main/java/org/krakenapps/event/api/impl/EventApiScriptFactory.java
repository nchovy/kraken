...
@Component(name = "event-api-script-factory")
@Provides
public class EventApiScriptFactory implements ScriptFactory {
	@SuppressWarnings("unused")
	@ServiceProperty(name = "alias", value = "evtapi")
	...
	public Script createScript() {
		return new EventApiScript(dispatcher, providerRegistry, messageTable);
	}
