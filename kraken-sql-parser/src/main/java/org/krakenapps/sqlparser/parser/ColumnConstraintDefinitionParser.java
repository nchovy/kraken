...
public class ColumnConstraintDefinitionParser implements Parser {

	@Override
	public Object parse(Binding b) {
		if (b.getChildren() != null)
			throw new IllegalStateException("TODO: additional column definition properties");

		return new ColumnConstraintDefinition((ColumnConstraint) b.getValue());
	}
