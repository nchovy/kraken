...
public class AlterTableStatementParser implements Parser {

	@Override
	public Object parse(Binding b) {
		String tableName = (String) b.getChildren()[2].getValue();

		AlterTableAction alterTableAction = (AlterTableAction) b.getChildren()[3].getValue();
		return new AlterTableStatement(tableName, alterTableAction);
	}
